...
/// please submit an issue to [workspaces](https://github.com/unc/workspaces-rs/issues).
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl From<BlockHeaderView> for BlockHeader {
    fn from(header_view: BlockHeaderView) -> Self {
        Self {
            ...
            gas_price: UncToken::from_yoctounc(header_view.gas_price),
            block_ordinal: header_view.block_ordinal,
            total_supply: UncToken::from_yoctounc(header_view.total_supply),
