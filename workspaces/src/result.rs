...
use crate::types::{CryptoHash, Gas, UncToken};
...
impl ExecutionFinalResult {
    pub(crate) fn from_view(view: FinalExecutionOutcomeView) -> Self {
        ...
        let total_gas_burnt = UncGas::from_gas(total_gas_burnt);
        Self {
            total_gas_burnt,
            status: view.status,
    ...
    fn from(view: ExecutionOutcomeWithIdView) -> Self {
        Self {
            ...
            receipt_ids: view
                ...
                .collect(),
            gas_burnt: UncGas::from_gas(view.outcome.gas_burnt),
            tokens_burnt: UncToken::from_yoctounc(view.outcome.tokens_burnt),
