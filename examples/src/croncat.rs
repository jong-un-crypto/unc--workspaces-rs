...
pub async fn run_scheduled_tasks(
    ...
    let outcome = agent
        ...
        .args_json(json!({}))
        .deposit(UncToken::from_yoctounc(2260000000000000000000u128))
        .transact()
        .await?;
    ...
    assert_eq!(
        ...
        UncToken::from_yoctounc(3860000000000000000000u128)
    );
    ...
    assert_eq!(
        agent_details.balance,
        UncToken::from_yoctounc(2260000000000000000000u128)
    );
    ...
    println!(
        ...
        before_withdraw.a.as_yoctounc() - agent_details.balance.a.as_yoctounc()
    );
